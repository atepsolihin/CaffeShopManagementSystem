...
public class mainDashboardController implements Initializable {
    ...
    private void handleLogout(ActionEvent event) {
        // Kode untuk logout, misalnya kembali ke halaman login
    }
...
// LETS PROCEED TO OUR DASHBOARD FORM : )
    ...
    private static class productData {
        ...
        private productData(int aInt, String string, String string0, String string1, int aInt0, double aDouble, String string2, String string3, java.sql.Date date) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private productData(int aInt, String string, String string0, String string1, int aInt0, double aDouble, String string2, java.sql.Date date) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    ...
    private static class cardProductController {

        public cardProductController() {
        }

        private void setData(productData get) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }

    private static class ControllerFormLain {

        public ControllerFormLain() {
        }
    }
